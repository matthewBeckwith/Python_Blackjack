...
class Game:
    ...
    def check_dealer_action():
        ...
        if(len(Dealer.current_hand) == 2 and Game.get_hand_worth(Dealer.current_hand) == 21):
            ...
            if(Game.get_hand_worth(Player.current_hand) == 21):
                print("You and the Dealer Push; Recieve your bet back")
            ...
            if(check < 17):
                ...
                if(Game.get_hand_worth(Dealer.current_hand) > 21):
                    ...
                    print("Dealer has {} worth {}".format(Game.show_hand(Dealer.current_cards),str(Game.get_hand_worth(Dealer.current_hand))))
                    print("You have {} worth {}".format(Game.show_hand(Player.current_cards),str(Game.get_hand_worth(Player.current_hand))))
    ...
    def give_card(who):
        ...
        if(card > 10):
            if(card == 11):
                who.current_cards.append('J ' + Game.deck['suits'][random.randrange(0,len(Game.deck['suits']))][1])
            elif(card == 12):
                who.current_cards.append('Q ' + Game.deck['suits'][random.randrange(0,len(Game.deck['suits']))][1])
            elif(card == 13):
                who.current_cards.append('K ' + Game.deck['suits'][random.randrange(0,len(Game.deck['suits']))][1])
            elif(card == 14):
                who.current_cards.append('A ' + Game.deck['suits'][random.randrange(0,len(Game.deck['suits']))][1])
        else:
            who.current_cards.append(str(card) + ' ' + Game.deck['suits'][random.randrange(0,len(Game.deck['suits']))][1])
